...
const Header = ({}) => {
  ...
  useDismissModal(openProfile, onCloseProfile);
    ...
    <>
      <header
        className={
          sidebarIsOpen
            ? styles.page_header
            : `${styles.page_header} ${styles.page_header_full}`
        }
      >
        <div className={styles.header_section_1}>
          <span
            onClick={() => dispatch({ type: "OPEN_SIDEBAR" })}
            className={`${styles.header_icon} ${styles.navbar_menuIcon}`}
            id={styles.navbar__menuIcon}
          >
